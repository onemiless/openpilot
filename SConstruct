...
if arch == "comma_arm64":
  ...
  # Keep the legacy macro while local C3XL/Tesla code migrates to the
  # platform-neutral name. Both describe the same AGNOS hardware target.
  arch_flags = ["-D__COMMA_HARDWARE__", "-D__TICI__", "-mcpu=cortex-a57", "-DQCOM2"]
