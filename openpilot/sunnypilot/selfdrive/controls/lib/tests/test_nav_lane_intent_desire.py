...
def intent(*, direction="left", authorized=False, signal=True):
  return SimpleNamespace(valid=True, signalRequested=signal, laneChangeAuthorized=authorized, direction=direction)
