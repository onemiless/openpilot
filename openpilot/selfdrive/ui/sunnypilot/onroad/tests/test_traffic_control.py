...
def test_all_english_action_labels_fit_the_card_at_render_size():
  ...
  labels = {expected for _, expected in ACTION_CASES if expected} | {
    ...
    "Stop control · smooth transition",
    "Red · stop control applied",
    "Signal changing · stop applied",
    "Green · auto start applied",
    "Green · stop control released",
    "Stop control · transition applied",
    "Green · continuing applied",
  }
