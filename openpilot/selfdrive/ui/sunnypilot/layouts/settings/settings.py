...
class NavButton(Widget):
  ...
  def _render(self, rect):
    ...
    content_x = rect.x + 90
    label = tr(self.panel_info.name)
    text_size = measure_text_cached(self.parent._font_medium, label, 65)
    ...
    rl.draw_text_ex(self.parent._font_medium, label, text_pos, 55, 0, text_color)
...
class SettingsLayoutSP(OP.SettingsLayout):
  def __init__(self):
    ...
    self._panels = {
      ...
      # OP.PanelType.SUNNYLINK: PanelInfo(tr_noop("sunnylink"), SunnylinkLayout(), icon="icons/wifi_strength_full.png"),  # hidden
      # OP.PanelType.TOGGLES: PanelInfo(tr_noop("Toggles"), TogglesLayout(), icon="../../sunnypilot/selfdrive/assets/offroad/icon_toggle.png"),  # hidden, moved into Cruise
      ...
      # OP.PanelType.TRIPS: PanelInfo(tr_noop("Trips"), TripsLayout(), icon="../../sunnypilot/selfdrive/assets/offroad/icon_trips.png"),  # hidden
      OP.PanelType.VEHICLE: PanelInfo(tr_noop("Vehicle"), VehicleLayout(), icon="../../sunnypilot/selfdrive/assets/offroad/icon_vehicle.png"),
      # OP.PanelType.FIREHOSE: PanelInfo(tr_noop("Firehose"), FirehoseLayout(), icon="../../sunnypilot/selfdrive/assets/offroad/icon_firehose.png"),  # hidden
