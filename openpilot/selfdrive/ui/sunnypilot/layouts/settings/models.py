...
class ModelsLayout(Widget):
  ...
  def _initialize_items(self):
    self.current_model_item = ListItemSP(
      ...
      description="",
      action_item=ScrollingButtonAction(lambda: tr("SELECT")),
    ...
    self.cancel_download_item = button_item(lambda: tr("Cancel Download"), lambda: tr("Cancel"), "", lambda: ui_state.params.remove("ModelManager_DownloadRef"))
