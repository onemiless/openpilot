...
from openpilot.sunnypilot.models.helpers import get_selected_bundle, resolve_bundle_by_ref, select_default_model
from openpilot.common.constants import CV
from openpilot.selfdrive.ui.ui_state import device, ui_state
from openpilot.selfdrive.ui.sunnypilot.model_info import active_source, big_model_state, bundles_for_source, carrying_model, default_model_name, queued_name
...
class ModelsLayout(Widget):
  ...
  def _status_note(self) -> str:
    ...
    if not ui_state.usbgpu and active_source() != "usbgpu":
      return ""
  ...
  def _on_model_selected(self, result):
    ...
    if selected_ref == "Default":
      if self._selection_source in ("qcom", "usbgpu"):
        select_default_model(ui_state.params, self._selection_source)
      return
