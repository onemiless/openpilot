...
from openpilot.selfdrive.controls.lib.longitudinal_mpc_lib.long_mpc_tn import LongitudinalPlanSource as MpcLongitudinalPlanSource
from openpilot.selfdrive.controls.lib.longitudinal_backends.tn_no_dec.accel_controller.accel_controller import AccelController, AccelControllerState
from openpilot.selfdrive.controls.lib.longitudinal_backends.tn_no_dec.accel_controller.constants import BRAKING_ACCEL_THRESHOLD
...
class LongitudinalPlannerSP:
  ...
  def is_e2e(self, sm: messaging.SubMaster) -> bool:
    # TN-NoDEC deliberately preserves only the standard Experimental Mode
    # selection. Dynamic Experimental Control is not imported or consulted.
  ...
  def publish_longitudinal_plan_sp(self, sm: messaging.SubMaster, pm: messaging.PubMaster) -> None:
    ...
    # Keep the existing message field for compatibility; SCC-V now uses planned curvature.
