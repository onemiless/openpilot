...
def test_init_and_enable_disable():
...
def test_is_lane_change_blocked():
  controller = make_controller()
...
def test_should_trigger_lane_change():
  controller = make_controller()
