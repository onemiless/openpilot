...
inline static std::unordered_map<std::string, uint32_t> keys = {
    ...
    {"SupportedCars_tesla", PERSISTENT},
    {"SupportedCars_volkswagen", PERSISTENT},
    ...
    {"EnableTeslaTools", PERSISTENT},
    {"TeslaSpeedSyncEnabled", PERSISTENT},
    {"TeslaTurnSignalRequest", CLEAR_ON_MANAGER_START | DONT_LOG},
    {"TeslaTurnSignalCancel", CLEAR_ON_MANAGER_START | DONT_LOG},
    {"TeslaTurnSignalStatus", CLEAR_ON_MANAGER_START | DONT_LOG},
    {"TeslaTurnSignalResult", CLEAR_ON_MANAGER_START | DONT_LOG},
    {"TeslaSpeedSyncStatus", CLEAR_ON_MANAGER_START | DONT_LOG},
    ...
    {"TeslaRadarMotionInput", PERSISTENT},
    {"TeslaRadarConfigRequest", PERSISTENT | CLEAR_ON_MANAGER_START},
    {"TeslaRadarFilterRequest", PERSISTENT | CLEAR_ON_MANAGER_START},
    {"TeslaRadarConfigResult", CLEAR_ON_MANAGER_START},
    {"TeslaRadarFilterResult", CLEAR_ON_MANAGER_START},
    {"TeslaRadarStateMaxDistance", CLEAR_ON_MANAGER_START},
    {"TeslaRadarStateOutputType", CLEAR_ON_MANAGER_START},
    {"TeslaRadarStateExtended", CLEAR_ON_MANAGER_START},
    {"TeslaRadarStateQuality", CLEAR_ON_MANAGER_START},
    {"TeslaRadarStateSensorID", CLEAR_ON_MANAGER_START},
    {"TeslaRadarStateMotionRx", CLEAR_ON_MANAGER_START},
    {"TeslaRadarStateNVMRead", CLEAR_ON_MANAGER_START},
    {"TeslaRadarStateNVMWrite", CLEAR_ON_MANAGER_START},
    {"TeslaRadarStateCtrlRelay", CLEAR_ON_MANAGER_START},
    {"TeslaRadarStateRCSThreshold", CLEAR_ON_MANAGER_START},
    {"TeslaRadarStatePower", CLEAR_ON_MANAGER_START},
    {"TeslaRadarStateSort", CLEAR_ON_MANAGER_START},
    {"TeslaRadarStateSeq", CLEAR_ON_MANAGER_START},
    {"TeslaRadarFilterState", CLEAR_ON_MANAGER_START},
    {"TeslaRadarFilterStateSeq", CLEAR_ON_MANAGER_START},
