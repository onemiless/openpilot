...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"MpcCruiseMinAccel", {PERSISTENT | BACKUP, FLOAT, "-1.2"}},
    {"MpcCruiseMaxAccel", {PERSISTENT | BACKUP, FLOAT, "1.6"}},
    {"MpcLeadDangerFactor", {PERSISTENT | BACKUP, FLOAT, "0.35"}},
    {"MpcMinXLeadFactor", {PERSISTENT | BACKUP, FLOAT, "0.5"}},
    {"MpcCrashDistance", {PERSISTENT | BACKUP, FLOAT, "0.25"}},
    {"MpcComfortBrake", {PERSISTENT | BACKUP, FLOAT, "2.7"}},
    {"MpcStopDistance", {PERSISTENT | BACKUP, FLOAT, "4.5"}},
    {"MpcXObstacleCost", {PERSISTENT | BACKUP, FLOAT, "5.0"}},
    {"MpcJerkCost", {PERSISTENT | BACKUP, FLOAT, "3.0"}},
    {"MpcAChangeCost", {PERSISTENT | BACKUP, FLOAT, "100.0"}},
    {"MpcDangerZoneCost", {PERSISTENT | BACKUP, FLOAT, "80.0"}},
    {"MpcLimitCost", {PERSISTENT | BACKUP, INT, "1000000"}},
};
