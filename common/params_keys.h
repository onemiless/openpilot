...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"TeslaBMSDashboard", {PERSISTENT | BACKUP, BOOL, "0"}},
    {"TeslaBMSStatus", {CLEAR_ON_MANAGER_START, JSON}},
    {"TeslaFSDModStatus", {CLEAR_ON_MANAGER_START, JSON}},
    {"TeslaFSDUnlock", {PERSISTENT | BACKUP, BOOL, "0"}},
    {"TeslaISAChimeSuppress", {PERSISTENT | BACKUP, BOOL, "0"}},
    {"TeslaNagKiller", {PERSISTENT | BACKUP, BOOL, "0"}},
    {"TeslaPrecondition", {PERSISTENT | BACKUP, BOOL, "0"}},
    {"TeslaTurnSignal", {PERSISTENT | BACKUP, BOOL, "0"}},
